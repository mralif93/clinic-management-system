...
{
    /**
     * Display a listing of the staff's leaves
     */
    ...
    public function store(Request $request)
    {
        ...
        if (Leave::hasOverlap(Auth::id(), $validated['start_date'], $validated['end_date'])) {
            return back()
                ->withErrors(['start_date' => 'You already have a leave that overlaps with the selected dates.'])
                ->withInput();
        }
    ...
    {
        // Ensure the leave belongs to the authenticated staff
    ...
    public function edit(Leave $leave)
    {
        ...
        return view('staff.leaves.edit', compact('leave'));
    }
    ...
    public function update(Request $request, Leave $leave)
    {
        ...
        if (Leave::hasOverlap(Auth::id(), $validated['start_date'], $validated['end_date'], $leave->id)) {
            return back()
                ->withErrors(['start_date' => 'You already have a leave that overlaps with the selected dates.'])
                ->withInput();
        }

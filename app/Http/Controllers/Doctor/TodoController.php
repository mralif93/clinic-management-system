...
{
    /**
     * Display a listing of tasks assigned to the logged-in doctor.
     */
    public function index(Request $request)
    {
        ...
        return view('doctor.todos.index', compact('todos'));
    }
    ...
    public function show($id)
    {
        ...
        return view('doctor.todos.show', compact('todo'));
    }
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        return redirect()->route('doctor.todos.index')

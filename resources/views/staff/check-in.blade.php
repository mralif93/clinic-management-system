    ...
    <div
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div
                    class="bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 px-8 py-10 text-center relative overflow-hidden">
                    <!-- Background Pattern -->
                ...
                <div class="px-8 py-8">
                    ...
                    <div class="flex items-center gap-4 mb-8 p-4 bg-slate-50 rounded-2xl">
                        <div
                            class="w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-md">
            ...
            <div class="text-center mt-6">
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    ...
                    <button type="submit" class="text-slate-400 hover:text-white transition-colors text-sm">
                        <i class='hgi-stroke hgi-logout-01 mr-1'></i>
                        Logout instead
                    </button>
                </form>
            </div>

            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                    @for($date = $weekStart->copy(); $date <= $weekEnd; $date->addDay())
                        ...
                        @endphp
                        <div
                            class="border border-gray-200 rounded-lg p-3 {{ $isToday ? 'bg-yellow-50 border-yellow-300' : ($isSelected ? 'bg-blue-50 border-blue-300' : '') }}">
                            ...
                            <div class="space-y-1">
                                @foreach($dayAppointments->take(3) as $appointment)
                                    <div class="text-xs bg-yellow-100 text-yellow-800 rounded px-1 py-0.5 truncate"

    ...
    <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 {{ $todo->due_date && $todo->isOverdue() ? 'bg-red-100' : 'bg-gradient-to-br from-teal-500 to-cyan-600' }} rounded-lg flex items-center justify-center">
                        <i class='hgi-stroke hgi-calendar-03 {{ $todo->due_date && $todo->isOverdue() ? 'text-red-600' : 'text-white' }} text-xl'></i>
                    </div>
                    <div>
                        @if($todo->due_date)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6">
                        <form action="{{ route('staff.todos.update-status', $todo->id) }}" method="POST" class="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="relative">
                                    <i class='hgi-stroke hgi-loading-03 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
            ...
            <div class="space-y-6">
                ...
                <!-- Completion Status -->
                @if($todo->status === 'completed')
                <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl  p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-40 h-40 bg-white/10 rounded-full blur-3xl"></div>
                ...
                <div class="bg-gradient-to-br from-red-500 to-rose-600 rounded-xl  p-6 text-white shadow-lg relative overflow-hidden">
            <!-- Decorative background elements -->
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-white/10 rounded-full blur-2xl"></div>
            <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-40 h-40 bg-white/10 rounded-full blur-3xl"></div>
                    <div class="flex items-center gap-4">

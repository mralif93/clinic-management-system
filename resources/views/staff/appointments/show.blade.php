    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('staff.appointments.edit', $appointment->id) }}" class="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition">
                    <i class='bx bx-edit mr-2'></i> Edit
                </a>
                <a href="{{ route('staff.appointments.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    Back to List
                </a>
            </div>
        </div>
            ...
            <div class="mt-8 bg-gray-50 rounded-lg p-6">
                ...
                <form action="{{ route('staff.appointments.update-status', $appointment->id) }}" method="POST">
                    ...
                    <div class="flex items-center space-x-4">
                        <select name="status" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent" required>

        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-600 rounded-lg flex items-center justify-center">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-green-600">
                            +{{ get_currency_symbol() }}{{ number_format($payroll->total_allowances ?? 0, 2) }}</p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-red-500 to-rose-600 rounded-lg flex items-center justify-center">
                        <i class='hgi-stroke hgi-minus-sign-circle text-white text-xl'></i>
                    </div>
                    <div>
                        <p class="text-sm font-semibold text-red-600">
                            -{{ get_currency_symbol() }}{{ number_format($payroll->total_deductions ?? 0, 2) }}</p>

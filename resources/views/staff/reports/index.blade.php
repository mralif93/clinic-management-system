...
@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div
            class="bg-gradient-to-br from-indigo-500 via-purple-600 to-indigo-800 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div class="flex items-center gap-2 mb-4">
                <i class='hgi-stroke hgi-filter text-indigo-500 text-xl'></i>
            ...
            <form method="GET" action="{{ route('staff.reports.index') }}" class="flex flex-wrap gap-4 items-end">
                ...
                <button type="submit"
                    ...
                    <i class='hgi-stroke hgi-filter mr-2'></i> Apply Filter
                </button>

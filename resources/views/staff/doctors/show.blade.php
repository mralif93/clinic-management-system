    ...
    <div class="space-y-6">
                ...
                <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div
                            class="shrink-0 w-12 h-12 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center shadow-inner border border-white/20 transform transition-transform hover:scale-105">
                            <span
                                class="text-white font-bold text-2xl">{{ strtoupper(substr($doctor->user->name ?? 'D', 0, 1)) }}</span>
                        </div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span
                            class="px-3 py-1.5 bg-white/20 backdrop-blur-sm text-white rounded-full text-sm font-medium border border-white/30">
                        ...
                        <a href="{{ route('staff.schedule.view-doctor', $doctor->id) }}"
                            ...
                            <i class='hgi-stroke hgi-calendar-03 mr-2'></i> View Schedule
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-purple-500 to-violet-600 rounded-lg flex items-center justify-center">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-lg flex items-center justify-center">
                        <i class='hgi-stroke hgi-star text-white text-xl'></i>
                    </div>
                    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-4">
                                @foreach($doctor->appointments->take(5) as $appointment)
                                    ...
                                    <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                                        <div
                                            class="w-14 h-14 bg-gradient-to-br from-cyan-400 to-teal-500 rounded-xl flex flex-col items-center justify-center text-white">
                                            <span
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h4 class="font-semibold text-gray-900 truncate">
                                                {{ $appointment->patient->full_name ?? 'Unknown Patient' }}</h4>
                                        ...
                                        <span
                                            class="px-3 py-1 text-xs font-semibold rounded-full {{ $statusColor['bg'] }} {{ $statusColor['text'] }}">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        <h3 class="font-semibold text-gray-800 flex items-center gap-2">
                            <i class='hgi-stroke hgi-user text-cyan-500'></i>
                            Basic Information
                        </h3>
                    </div>
                    <div class="p-4 space-y-3">
                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                            <i class='hgi-stroke hgi-identity-card text-gray-400'></i>
                            <div>
                        ...
                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                            <i class='hgi-stroke hgi-award-01 text-gray-400'></i>
                            <div>
                ...
                @if($doctor->bio)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                            <h3 class="font-semibold text-gray-800 flex items-center gap-2">
                                <i class='hgi-stroke hgi-information-circle text-cyan-500'></i>
                                About
                            </h3>
                        </div>
                        <div class="p-4">

            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <h4 class="font-semibold text-gray-900">
                                                        {{ $appointment->service->name ?? 'N/A' }}</h4>
                        ...
                        @else
                            <p class="text-gray-500 text-center py-8">No appointments found. <a
                                    href="{{ route('patient.appointments.create') }}" class="text-blue-600 hover:underline">Book
                                    your first appointment</a></p>
                        @endif
                    </div>
                </div>
            </div>

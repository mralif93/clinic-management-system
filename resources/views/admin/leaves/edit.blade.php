            ...
            <div
                ...
                <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold">Edit Leave Record</h2>
                            <p class="text-violet-100 text-sm mt-1">Update leave details for {{ $leave->user->name }}</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('admin.leaves.update', $leave->id) }}" method="POST"
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                            <div class="flex items-center gap-3">
                                <div class="bg-blue-100 rounded-full p-2">
                                    <i class='hgi-stroke hgi-user text-blue-600 text-xl'></i>
                                </div>
                                <div>
                        ...
                        <div>
                            ...
                            <textarea name="reason" id="reason" rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Reason for leave..." required>{{ old('reason') ?? $leave->reason }}</textarea>
                            @error('reason')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="admin_notes" id="admin_notes" rows="2"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Internal notes...">{{ old('admin_notes') ?? $leave->admin_notes }}</textarea>
                            @error('admin_notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

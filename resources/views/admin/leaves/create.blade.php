...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-3xl mx-auto">
            <div
                class="bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden mb-8">
                ...
                <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div class="flex items-center gap-4">
                        <div
                            ...
                            <i class='hgi-stroke hgi-calendar-add-01 text-2xl'></i>
                        </div>
                        <div>
                            <h2 class="text-2xl font-bold">Create Leave Record</h2>
                            <p class="text-violet-100 text-sm mt-1">Manually create a leave record for an employee</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="p-8">
                    <form action="{{ route('admin.leaves.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <!-- Employee Selection -->
                        <div>
                            <label for="user_id" class="block text-sm font-medium text-gray-700 mb-2">Employee <span
                        ...
                        <div>
                            ...
                            <textarea name="reason" id="reason" rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Reason for leave..." required>{{ old('reason') }}</textarea>
                            @error('reason')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">Slug: <span class="font-mono text-xs">{{ $service->slug }}</span></p>
                    <p class="mt-1 text-sm text-gray-500">Slug will be automatically updated if name changes</p>
                </div>
                ...
                <div>
                    ...
                    <select id="type" 
                        ...
                        <option value="general" {{ old('type', $service->type) == 'general' ? 'selected' : '' }}>General</option>
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror

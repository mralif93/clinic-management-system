...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-cyan-100 text-sm mt-1">Manage clinic services and treatments</p>
    </div>
</div>
    ...
    <!-- Quick Stats -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
                ...
                <p class="text-sm text-gray-500 font-medium mt-1">Total Services</p>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
                <p class="text-2xl font-bold text-gray-900">{{ $psychologyCount }}</p>
                <p class="text-sm text-gray-500 font-medium mt-1">Psychology</p>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
                <p class="text-2xl font-bold text-gray-900">{{ $generalCount }}</p>

        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-blue-100">{{ $announcement->title }}</p>
                </div>
            ...
            <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 border-b border-gray-100">
                    <textarea id="description" name="description" rows="6"
                        ...
                        placeholder="Enter announcement description...">{{ old('description', $announcement->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1"><i class='bx bx-error-circle'></i>
                            {{ $message }}</p>
                    @enderror
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $announcement->image ? 'Upload New Image' : 'Upload Image' }}
                    </label>

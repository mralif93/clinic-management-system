                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-xl">
                        ...
                        <div id="recurrence_type_container" class="hidden mt-4">
                            <label for="recurrence_type" class="block text-sm font-medium text-gray-700 mb-2">Recurrence
                                Type</label>
                            ...
                            <p class="mt-2 text-xs text-indigo-700 flex items-center gap-1">
                                <i class='hgi-stroke hgi-information-circle'></i> System will automatically create new
                                instances of this

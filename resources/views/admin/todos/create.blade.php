...
<div class="space-y-6">
    ...
    <div>
        <h2 class="text-2xl font-bold">Create New To-Do</h2>
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @error('title')
                            <p class="mt-2 text-sm text-red-600 flex items-center gap-1"><i class='hgi-stroke hgi-alert-circle'></i> {{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-xl">
                    ...
                    <div id="recurrence_type_container" class="hidden mt-4">
                        ...
                        <p class="mt-2 text-xs text-indigo-700 flex items-center gap-1">
                            <i class='hgi-stroke hgi-information-circle'></i> System will automatically create new instances of this task based on the selected frequency.
                        </p>
                    </div>
                </div>
            </div>

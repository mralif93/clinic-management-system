                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="marital_status" name="marital_status"
                                ...
                                <option value="married_spouse_working" {{ old('marital_status') == 'married_spouse_working' ? 'selected' : '' }}>Married (Spouse Working)</option>
                                <option value="married_spouse_not_working" {{ old('marital_status') == 'married_spouse_not_working' ? 'selected' : '' }}>Married (Spouse
                                    Not Working)</option>
                            </select>

    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" id="editUserForm">
                ...
                <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        <i class='hgi-stroke hgi-file-check-01 text-blue-600'></i>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="marital_status" name="marital_status"
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm bg-white @error('marital_status') border-red-500 @enderror">
                                <option value="single" {{ old('marital_status', $user->marital_status) == 'single' ? 'selected' : '' }}>Single</option>
                                <option value="married" {{ old('marital_status', $user->marital_status) == 'married' ? 'selected' : '' }}>Married</option>
                                <option value="married_spouse_working" {{ old('marital_status', $user->marital_status) == 'married_spouse_working' ? 'selected' : '' }}>Married (Spouse
                                    Working)</option>
                                <option value="married_spouse_not_working" {{ old('marital_status', $user->marital_status) == 'married_spouse_not_working' ? 'selected' : '' }}>Married
                                    (Spouse Not Working)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" id="number_of_children" name="number_of_children"
                                value="{{ old('number_of_children', $user->number_of_children) }}" min="0"
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm @error('number_of_children') border-red-500 @enderror"
                                placeholder="0">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="tax_number" name="tax_number"
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm @error('tax_number') border-red-500 @enderror"

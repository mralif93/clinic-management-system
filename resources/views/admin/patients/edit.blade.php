            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" 
                              name="address" 
                              rows="2"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('address', $patient->address) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="medical_history" 
                              ...
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('medical_history', $patient->medical_history) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="allergies" 
                              name="allergies" 
                              rows="2"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('allergies', $patient->allergies) }}</textarea>
                </div>

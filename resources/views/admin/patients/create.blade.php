...
@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div class="bg-gradient-to-r from-rose-600 to-pink-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
    ...
    <div>
        <h2 class="text-2xl font-bold">Create New Patient</h2>
        <p class="text-rose-100 text-sm mt-1">Add a new patient to the system</p>
    </div>
</div>
            ...
            <form action="{{ route('admin.patients.store') }}" method="POST" id="createPatientForm">
                ...
                <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        <i class='hgi-stroke hgi-link-01 text-rose-600'></i>
                        Link to User Account
                    </h3>
                    <p class="text-sm text-gray-500 mt-1">Optional - Connect this patient to an existing user account</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 transition-all text-sm @error('phone') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="medical_history" name="medical_history" rows="3"
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 transition-all text-sm"
                                placeholder="Enter any relevant medical history...">{{ old('medical_history') }}</textarea>
                        </div>

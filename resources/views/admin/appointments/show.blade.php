                ...
                <div class="flex space-x-2">
                    @if(!$appointment->trashed())
                        <a href="{{ route('admin.appointments.invoice', $appointment->id) }}"
                            ...
                            <i class='bx bx-receipt mr-2 text-base'></i> Invoice
                        </a>
            ...
            <div class="p-6">
                        ...
                        <div class="space-y-0 divide-y divide-gray-100">
                            ...
                            <div class="flex items-center justify-between py-3.5">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <span
                                        class="px-3 py-1 inline-flex text-sm font-semibold rounded-full {{ $statusColors[$appointment->status] ?? 'bg-gray-50 text-gray-700 border border-gray-200' }}">
                            ...
                            @if($appointment->fee)
                                <div class="flex items-center justify-between py-3.5">
                                    ...
                                    <p class="text-gray-900">
                                        {{ get_currency_symbol() }}{{ number_format($appointment->fee, 2) }}</p>
                                </div>
                            @endif
                            @if($appointment->discount_type && $appointment->discount_value > 0)
                                ...
                                <div class="flex items-center justify-between py-3.5 bg-gray-50 -mx-2 px-2 rounded">
                                    ...
                                    <p class="text-gray-900 font-bold">
                                        {{ get_currency_symbol() }}{{ number_format($appointment->final_amount, 2) }}</p>
                                </div>
                            @endif
                            <div class="flex items-center justify-between py-3.5">
                        ...
                        <div>
                            ...
                            <div class="space-y-0 divide-y divide-gray-100">
                                ...
                                <div class="flex items-center justify-between py-3.5">
                                    ...
                                    <p class="text-gray-900">
                                        {{ get_setting('currency', '$') }}{{ number_format($appointment->service->price, 2) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                @if($appointment->notes)
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="text-gray-900 prose max-w-none">{!! $appointment->notes !!}</div>
                    </div>
                @endif
                ...
                @if($appointment->diagnosis)
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="text-gray-900 prose max-w-none">{!! $appointment->diagnosis !!}</div>
                    </div>
                @endif
                ...
                @if($appointment->prescription)
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="text-gray-900 prose max-w-none">{!! $appointment->prescription !!}</div>
                    </div>
                @endif

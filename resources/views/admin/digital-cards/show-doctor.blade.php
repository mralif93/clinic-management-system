    ...
    <div class="space-y-6">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.digital-cards.index') }}"
                class="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-600 font-medium rounded-xl hover:bg-gray-50 border border-gray-200 transition text-sm">
                <i class='hgi-stroke hgi-arrow-left-01'></i> All Cards
            </a>
            <div class="bg-white rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-500">
                Viewing: <span class="font-bold text-gray-900">{{ $doctor->full_name }}</span>
            </div>
        </div>

...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Schedule Settings</h1>
                <p class="text-gray-600 mt-1">Configure your weekly working schedule</p>
            </div>
            <a href="{{ route('doctor.schedule.index') }}"
                ...
                <i class='bx bx-arrow-back mr-2'></i> Back to Schedule
            </a>
        </div>
        ...
        <form method="POST" action="{{ route('doctor.schedule.save-settings') }}" class="space-y-6">
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition shadow-md hover:shadow-lg">

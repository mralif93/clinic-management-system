...
@section('content')
    <div class="space-y-6">
            ...
            <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-white">
                        ...
                        <p class="text-emerald-100 text-sm mt-1">Update your pending leave request</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ route('doctor.leaves.update', $leave->id) }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div id="duration_display"
                        ...
                        <p class="text-emerald-800 font-medium">Total Duration: <span id="total_days"
                                class="font-bold">{{ $leave->total_days }}</span> days</p>
                    </div>
                        ...
                        @if($leave->attachment)
                            <div class="mb-4 flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                                <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center">
                                    <i class='hgi-stroke hgi-file-01 text-xl text-blue-600'></i>
                                </div>
                                <div class="flex-1">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit"
                            ...
                            <i class='hgi-stroke hgi-floppy-disk mr-2'></i> Update Request
                        </button>
                    </div>
                </form>
            </div>

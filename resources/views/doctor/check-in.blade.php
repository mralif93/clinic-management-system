...
@section('content')
    <div
        class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/50 backdrop-blur-md p-6 overflow-y-auto">
        <div class="w-full max-w-md">
            <!-- Check-in Card -->
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <!-- Header with Gradient -->
                <div
                    class="bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 px-8 py-10 text-center relative overflow-hidden">
                    <!-- Background Pattern -->
                    ...
                    <div class="relative inline-flex items-center justify-center mb-4">
                        ...
                        <div
                            ...
                            <i class='hgi-stroke hgi-clock-02 text-5xl text-emerald-500'></i>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    ...
                    <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-5 mb-6 border border-emerald-100">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center text-white text-xl font-bold shadow-lg">
                    ...
                    <form action="{{ route('doctor.check-in.store') }}" method="POST" id="checkInForm">
                        ...
                        <button type="submit" id="checkInBtn"
                            ...
                            <i class='hgi-stroke hgi-login-02 text-2xl'></i>
                            CHECK IN NOW
                        </button>
                    </form>
            ...
            <div class="mt-6 text-center">
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    ...
                    <button type="submit" class="text-white/60 hover:text-white text-sm transition-colors">
                        <i class='hgi-stroke hgi-logout-01 mr-1'></i> Logout instead
                    </button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById('checkInForm').addEventListener('submit', function (e) {
            ...
            Swal.fire({
                ...
                confirmButtonText: '<i class="hgi-stroke hgi-checkmark-circle-02 mr-1"></i> Yes, Check In',

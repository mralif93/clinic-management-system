...
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('doctor.appointments.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                Back to List
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 font-semibold">{{ get_currency_symbol() }}{{ number_format($appointment->fee, 2) }}</p>
                    </div>
                    @endif
                </div>
            </div>
                ...
                <form action="{{ route('doctor.appointments.update-status', $appointment->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" required>
                        ...
                        <div>
                            ...
                            <textarea name="diagnosis" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Enter diagnosis...">{{ $appointment->diagnosis }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Prescription</label>
                            <textarea name="prescription" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Enter prescription...">{{ $appointment->prescription }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                            <textarea name="notes" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="Enter notes...">{{ $appointment->notes }}</textarea>
                        </div>
                    </div>
                    <div class="mt-4">

        ...
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-green-600 font-semibold">{{ $patient->patient_id ?? 'N/A' }}</p>
                </div>
            </div>
            <a href="{{ route('doctor.patients.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                Back to List
            </a>
        </div>

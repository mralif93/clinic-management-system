            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-calendar-plus text-gray-300 text-2xl'></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-time text-gray-300 text-2xl'></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-qr text-gray-300 text-2xl'></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-scan text-gray-300 text-2xl'></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-user-check text-gray-300 text-2xl'></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <i class='bx bx-check-circle text-gray-300 text-2xl'></i>
                    </div>
                </div>
            </div>

            <!-- CTA -->
            <div class="mt-8 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white text-center">
